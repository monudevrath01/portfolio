      ...
      <section className="projects-section" id="projects">
        <div className="container">
          ...
          <div className="row g-4 mt-2" id="projects-cards-container">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="project-card" id="project-blogchat">
                <div>
                  <div className="project-icon"><i className="bi bi-chat-left-text-fill"></i></div>
                  <h3 className="project-title text-white">Blog & Chat App</h3>
                  <p className="project-desc">
                    Developed a real-time blog and chat application. Implemented features for user posts, commenting, and live chatting using WebSockets (Socket.io) with a fully responsive and modern user interface.
                  </p>
                </div>
                <div>
                  <div className="project-tags">
                  ...
                  <a href="https://github.com/monudevrath01/blog-chat.git" target="_blank" rel="noreferrer" className="project-link" id="link-proj-blogchat">
                    GitHub Code <i className="bi bi-arrow-right"></i>
                  </a>
                </div>
              </div>
